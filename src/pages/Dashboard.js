      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 rounded-lg p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              부산 온천장의 인기 러닝 코스를 체험해보세요.
            </p>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-500">총 거리</div>
            <div className="text-lg font-bold text-purple-600">5.5km</div>
            <div className="text-xs text-gray-500">예상 시간: 30분</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 mb-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-gray-800">온천장 러닝 코스</h4>
              <p className="text-sm text-gray-600 mt-1">
                <span className="font-medium">시작:</span> 온천장 남쪽 (35.220462, 129.086192)<br/>
                <span className="font-medium">회전:</span> 온천장 북쪽 (35.234004, 129.091775)<br/>
                <span className="font-medium">특징:</span> 도로를 따라 자연스럽게 이어지는 순환 코스
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <div className="bg-white rounded-lg p-3 text-center">
            ...
            <div className="font-bold text-gray-800">5:30-6:30</div>
          </div>
          <div className="bg-white rounded-lg p-3 text-center">
            <div className="text-2xl mb-1">❤️</div>
            <div className="text-xs text-gray-500">심박수</div>
            <div className="font-bold text-gray-800">130-170</div>
          </div>
          <div className="bg-white rounded-lg p-3 text-center">
            <div className="text-2xl mb-1">🔥</div>
            <div className="text-xs text-gray-500">칼로리</div>
            <div className="font-bold text-gray-800">~350 kcal</div>
          </div>
          <div className="bg-white rounded-lg p-3 text-center">
            <div className="text-2xl mb-1">👟</div>
            <div className="text-xs text-gray-500">걸음수</div>
            <div className="font-bold text-gray-800">~7,000</div>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white py-3 rounded-lg font-bold text-lg transition-all transform hover:scale-105 shadow-lg"
        >
        ...
        <div className="mt-3 text-xs text-gray-500 text-center">
          💡 GPS로 실시간 위치를 추적하며 운동 데이터를 기록합니다.
        </div>
      </div>
